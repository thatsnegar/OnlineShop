...
{
	public class DoctorsRegistrationViewModel : object
	{
		public DoctorsRegistrationViewModel() : base()
		{
			IsActive = false;
		}
		...
		[Display(
			ResourceType = typeof(Resources.Tables.User),
			Name = nameof(Resources.Tables.User.Specialty))]
		...
		[Display(
			ResourceType = typeof(Resources.Tables.User),
			Name = nameof(Resources.Tables.User.Address))]
