...
namespace DAL.Migrations
{
    ...
    [Migration("20230107131741_Add-display-order-to-question")]
    partial class Adddisplayordertoquestion
    {
            ...
            modelBuilder.Entity("Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0a8d35e3-14b9-4cc2-a0c9-9b8fbe8d650a"),
                            DeleteDateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            InsertDateTime = new DateTime(2023, 1, 7, 16, 47, 40, 833, DateTimeKind.Local).AddTicks(3906),
                            IsEdited = false,
                            Name = "Developer",
                            UpdateDateTime = new DateTime(2023, 1, 7, 16, 47, 40, 833, DateTimeKind.Local).AddTicks(3940)
                        });
                });
            ...
            modelBuilder.Entity("Models.SequenceNumber", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("469137d5-93ca-4ec4-ac78-5045340ee420"),
                            DeleteDateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            InsertDateTime = new DateTime(2023, 1, 7, 16, 47, 40, 833, DateTimeKind.Local).AddTicks(4494),
                            IsEdited = false,
                            Name = "TracingCode",
                            Number = 1,
                            UpdateDateTime = new DateTime(2023, 1, 7, 16, 47, 40, 833, DateTimeKind.Local).AddTicks(4498)
                        },
                        new
                        {
                            Id = new Guid("f722bbed-d807-4ff2-8f0c-43d5874b677d"),
                            DeleteDateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            InsertDateTime = new DateTime(2023, 1, 7, 16, 47, 40, 833, DateTimeKind.Local).AddTicks(4523),
                            IsEdited = false,
                            Name = "RegisterDiscount",
                            Number = 1,
                            UpdateDateTime = new DateTime(2023, 1, 7, 16, 47, 40, 833, DateTimeKind.Local).AddTicks(4525)
                        });
                });
            ...
            modelBuilder.Entity("Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b490fecd-7738-40b6-9087-cf98d4dc92a3"),
                            BirthDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DeleteDateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EmailAddress = "info@fidarafzar.ir",
                            Gender = 2,
                            InsertDateTime = new DateTime(2023, 1, 7, 16, 47, 40, 833, DateTimeKind.Local).AddTicks(4149),
                            IsActive = true,
                            IsEdited = false,
                            Password = "069d28fa7cad5da31006c8a765c831a69ac1866ff32fae5ef3f9c8ae19118b86",
                            RoleId = new Guid("0a8d35e3-14b9-4cc2-a0c9-9b8fbe8d650a"),
                            UpdateDateTime = new DateTime(2023, 1, 7, 16, 47, 40, 833, DateTimeKind.Local).AddTicks(4152),
                            Username = "developer"
                        });
                });
