...
namespace DAL.Migrations
{
    ...
    [Migration("20221023085935_initial-Database")]
            ...
            modelBuilder.Entity("Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1d337488-1742-4328-a046-781d534899cb"),
                            DeleteDateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            InsertDateTime = new DateTime(2022, 10, 23, 12, 29, 35, 534, DateTimeKind.Local).AddTicks(4981),
                            IsEdited = false,
                            Name = "Developer",
                            UpdateDateTime = new DateTime(2022, 10, 23, 12, 29, 35, 534, DateTimeKind.Local).AddTicks(5014)
                        });
                });
            ...
            modelBuilder.Entity("Models.SequenceNumber", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4c5b7887-5017-460f-8b03-ccdbd49210ec"),
                            DeleteDateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            InsertDateTime = new DateTime(2022, 10, 23, 12, 29, 35, 534, DateTimeKind.Local).AddTicks(5932),
                            IsEdited = false,
                            Name = "TracingCode",
                            Number = 1,
                            UpdateDateTime = new DateTime(2022, 10, 23, 12, 29, 35, 534, DateTimeKind.Local).AddTicks(5939)
                        },
                        new
                        {
                            Id = new Guid("cf62fea1-06c4-425b-8feb-6e31c8d986f6"),
                            DeleteDateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            InsertDateTime = new DateTime(2022, 10, 23, 12, 29, 35, 534, DateTimeKind.Local).AddTicks(5962),
                            IsEdited = false,
                            Name = "RegisterDiscount",
                            Number = 1,
                            UpdateDateTime = new DateTime(2022, 10, 23, 12, 29, 35, 534, DateTimeKind.Local).AddTicks(5963)
                        });
                });
            ...
            modelBuilder.Entity("Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("07aa8f37-dc5c-4d05-a477-ad0608c3d3ea"),
                            BirthDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DeleteDateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EmailAddress = "moghadasian.vahidreza@gmail.com",
                            Gender = 2,
                            InsertDateTime = new DateTime(2022, 10, 23, 12, 29, 35, 534, DateTimeKind.Local).AddTicks(5232),
                            IsActive = true,
                            IsEdited = false,
                            Password = "483742cefbc362f54f266c92e1b38eafe6795f2ec8f44efef644ffd7afaf213c",
                            RoleId = new Guid("1d337488-1742-4328-a046-781d534899cb"),
                            UpdateDateTime = new DateTime(2022, 10, 23, 12, 29, 35, 534, DateTimeKind.Local).AddTicks(5235),
                            Username = "developer"
                        });
                });
