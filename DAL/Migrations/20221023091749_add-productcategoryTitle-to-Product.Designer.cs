...
namespace DAL.Migrations
{
    ...
    [Migration("20221023091749_add-productcategoryTitle-to-Product")]
    partial class addproductcategoryTitletoProduct
    {
            ...
            modelBuilder.Entity("Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4f2c5f5a-df4e-4627-a42f-139039e8bec0"),
                            DeleteDateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            InsertDateTime = new DateTime(2022, 10, 23, 12, 47, 49, 116, DateTimeKind.Local).AddTicks(4226),
                            IsEdited = false,
                            Name = "Developer",
                            UpdateDateTime = new DateTime(2022, 10, 23, 12, 47, 49, 116, DateTimeKind.Local).AddTicks(4260)
                        });
                });
            ...
            modelBuilder.Entity("Models.SequenceNumber", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e79f0e38-da7e-4e22-9323-8ab3d64cb7a9"),
                            DeleteDateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            InsertDateTime = new DateTime(2022, 10, 23, 12, 47, 49, 116, DateTimeKind.Local).AddTicks(5212),
                            IsEdited = false,
                            Name = "TracingCode",
                            Number = 1,
                            UpdateDateTime = new DateTime(2022, 10, 23, 12, 47, 49, 116, DateTimeKind.Local).AddTicks(5218)
                        },
                        new
                        {
                            Id = new Guid("c6307815-a53a-4e77-8fa8-3dcc5c7de5c5"),
                            DeleteDateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            InsertDateTime = new DateTime(2022, 10, 23, 12, 47, 49, 116, DateTimeKind.Local).AddTicks(5241),
                            IsEdited = false,
                            Name = "RegisterDiscount",
                            Number = 1,
                            UpdateDateTime = new DateTime(2022, 10, 23, 12, 47, 49, 116, DateTimeKind.Local).AddTicks(5243)
                        });
                });
            ...
            modelBuilder.Entity("Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("335db704-6088-4852-add2-8d6fd74cb14d"),
                            BirthDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DeleteDateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EmailAddress = "moghadasian.vahidreza@gmail.com",
                            Gender = 2,
                            InsertDateTime = new DateTime(2022, 10, 23, 12, 47, 49, 116, DateTimeKind.Local).AddTicks(4502),
                            IsActive = true,
                            IsEdited = false,
                            Password = "483742cefbc362f54f266c92e1b38eafe6795f2ec8f44efef644ffd7afaf213c",
                            RoleId = new Guid("4f2c5f5a-df4e-4627-a42f-139039e8bec0"),
                            UpdateDateTime = new DateTime(2022, 10, 23, 12, 47, 49, 116, DateTimeKind.Local).AddTicks(4506),
                            Username = "developer"
                        });
                });
